...
from locators.elements_page_locators import DynamicPropertiesPageLocators, UpLoadAndDownLoadPageLocators, ButtonsPageLocators, WebTablePageLocators, RadioButtonPageLocators, CheckBoxPageLocators, TextBoxPageLocators, LinksPageLocators
from selenium.webdriver.common.by import By
from generator.generator import genereted_persons, generated_file
...
class TextBoxPage(BasePage):
    ...
    def fill_all_fields(self):
        person_info = next(genereted_persons())
...
class CheckBoxPage(BasePage):
    ...
    def get_output_result(self):
        ...
        for item in result_list:
            data_out_titles.append(item.text)
...
class WebTablePage(BasePage):
    ...
    def add_new_person(self, count=1):
        while count != 0:
            ...
            self.element_is_visible(
                self.locators.FIRST_NAME_INPUT).send_keys(firstname)
            self.element_is_visible(
                self.locators.LAST_NAME_INPUT).send_keys(lastname)
            self.element_is_visible(
    ...
    def check_new_added_person(self):
        people_list = self.elements_are_presents(
    ...
    def check_count_rows(self):
        list_rows = self.elements_are_presents(self.locators.FULL_PERSON_LIST)
...
class ButtonsPage(BasePage):
    ...
    def click_on_different_button(self, type_click):
        if type_click == 'double':
            ...
            return self.check_clicked_on_the_button(self.locators.SUCCES_DOUBLE)
        if type_click == 'right':
            self.action_right_click(self.element_is_visible(
                self.locators.RIGHT_CLICK_BUTTON))
            return self.check_clicked_on_the_button(self.locators.SUCCES_RIGHT)
        if type_click == 'click':
            self.element_is_visible(self.locators.CLICK_ME_BUTTON).click()
            return self.check_clicked_on_the_button(self.locators.SUCCES_CLICK_ME)
...
class UpLoadAndDownLoadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = rf'D:\NewFile\testfile{random.randint(0, 999)}.jpg'
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_enable_button(self):
        ...
        enable_button = self.element_is_clickable(
