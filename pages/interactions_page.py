...
class SelectablePage(BasePage):
    ...
    def select_list_item(self):
        ...
        active_element = self.element_is_visible(
            self.locators.LIST_ITEM_ACTIVE)
    ...
    def select_grid_item(self):
        ...
        active_element = self.element_is_visible(
            self.locators.GRID_ITEM_ACTIVE)
        return active_element.text
...
class DroppablePage(BasePage):
    ...
    def drop_prevent_propogation(self):
        ...
        text_not_greedy_box = self.element_is_visible(
            self.locators.NOT_GREEDY_DROP_BOX_TEXT).text
        ...
        text_greedy_box = self.element_is_visible(
            self.locators.GREEDY_DROP_BOX_TEXT).text
    ...
    def drop_will_not_revert_draggable(self):
        self.element_is_visible(self.locators.REVERT_TAB).click()
        will_not_revert = self.element_is_visible(self.locators.NOT_REVERT)
        drop_div = self.element_is_visible(self.locators.DROP_HERE_REVERT)
        self.action_drag_and_drop_to_element(will_not_revert, drop_div)
        position_after_move = will_not_revert.get_attribute('style')
        time.sleep(1)
        position_after_revert = will_not_revert.get_attribute('style')
        return position_after_move, position_after_revert
...
class DraggablePage(BasePage):
    ...
    def simple_drag_box(self):
        ...
        before_position, after_position = self.get_before_and_after_positions(
            drag_div)
        return before_position, after_position
    ...
    def axis_restricted_y(self):
        ...
        position_x = self.get_before_and_after_positions(only_y)
